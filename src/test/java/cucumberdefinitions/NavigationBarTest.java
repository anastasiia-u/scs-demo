...
public class NavigationBarTest {
    ...
    public void i_click_on_another_navigation_item() {
        mainPage.clickOnAnotherNavigationItem();
    }

    @When("I do not click on the {string} dropdown menu")
    public void i_do_not_click_on_the_dropdown_menu(String menuName) {
        // No action needed here as we are not clicking on the dropdown menu
    }
