...
public class TestDropdownFunctionality {
    MainPage mainPage;
    SolutionsPage solutionsPage;

    public TestDropdownFunctionality() {
    ...
    public void i_should_be_navigated_to_the_section_of_the_website(String sectionName) {
        Assertions.assertTrue(solutionsPage.isAtSection(sectionName));
    }
    ...
    public void no_navigation_should_occur_and_the_dropdown_should_remain_open() {
        ...
        Assertions.assertFalse(solutionsPage.isNavigationOccurred());
    }
}